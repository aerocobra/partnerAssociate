...
class partnerAssociate ( models.Model):
	...
	x_strAuthorizationTransport	= fields.Char		( string = "Autorización transporte",	size = 8,	help = "N Autorización de transporte")
	...
	x_strLicenceEU				= fields.Char		( string = "Licencia comunitaria",		size = 10,	help = "N Licencia comunitaria")
	#N autorizacion de operador tte, codigo 8 digitos
	x_strAuthorizationOperator	= fields.Char		( string = "Autorización operador",		size = 8,	help = "N Autorización de operador")
	...
	#control de riesgo
	x_idsTIR_Endorcement	= fields.One2many	(	comodel_name = "partner.associate.endorsement",
